...
---------------------------------
 ...
 begin 
    ...
    if ( m_company_id = 1 )  then --  Testing Company Rule
     ...
     return round(v_extraHoursValue , 0)  ; 
 end ; 
  --=================================================================
  ...
  begin
       ...
       extraKmValue   :=  round(extraKm * contract_car_rec.overkmrate/100 , 0) ; 
       ...
       set cc.returndate = return_date
          ...
          , cc.carincome = nvl ( round( noOfDays * cc.dayrate , 0)    -- ﬁÌ„… «·«Ì«„ 
...
begin
 ...
 if (v_car_income > total_act_payments ) then 
  ...
  values (m_branch_id ,  m_serialno , m_company_id , v_payment_req , v_drcr , ' ’›Ì… «·⁄ﬁœ  ·ﬁ«∆Ì«') ;
